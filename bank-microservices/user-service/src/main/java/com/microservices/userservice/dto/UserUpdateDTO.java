...
public class UserUpdateDTO {
    ...
    @Schema(description = "Address of the user", example = "Bulevar kralja Aleksandra 73")
    ...
    @Schema(description = "Company address of the user", example = "Bulevar kralja Aleksandra 73")
