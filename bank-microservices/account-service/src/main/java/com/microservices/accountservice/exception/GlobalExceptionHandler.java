...
public class GlobalExceptionHandler {
    ...
    public final ResponseEntity<ErrorDetails> handleAccountAlreadyExistsException(AccountAlreadyExistsException ex, WebRequest request) {
        List<String> details = new ArrayList<>();
        details.add(ex.getLocalizedMessage());
        ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now(), "Account Already Exists", request.getDescription(false), details);
        return new ResponseEntity<>(errorDetails, HttpStatus.CONFLICT);
    }

    @ExceptionHandler(LimitExceededException.class)
    public final ResponseEntity<ErrorDetails> handleLimitExceededException(LimitExceededException ex, WebRequest request) {
        List<String> details = new ArrayList<>();
        details.add(ex.getLocalizedMessage());
        ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now(), "Limit Exceeded", request.getDescription(false), details);
